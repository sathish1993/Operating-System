...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42a:	0f b6 80 cc 0a 00 00 	movzbl 0xacc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 566:	75 25                	jne    58d <printf+0xff>
          s = "(null)";
 568:	c7 45 f4 77 08 00 00 	movl   $0x877,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 62e:	a1 e8 0a 00 00       	mov    0xae8,%eax
...
free(void *ap)
{
 ...
 6f9:	a3 e8 0a 00 00       	mov    %eax,0xae8
}
 6fe:	90                   	nop
 6ff:	c9                   	leave  
 700:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 757:	83 c4 10             	add    $0x10,%esp
  return freep;
 75a:	a1 e8 0a 00 00       	mov    0xae8,%eax
}
 75f:	c9                   	leave  
 760:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 773:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 776:	a1 e8 0a 00 00       	mov    0xae8,%eax
 77b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 77e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 782:	75 23                	jne    7a7 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 784:	c7 45 f0 e0 0a 00 00 	movl   $0xae0,-0x10(%ebp)
 78b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 78e:	a3 e8 0a 00 00       	mov    %eax,0xae8
 793:	a1 e8 0a 00 00       	mov    0xae8,%eax
 798:	a3 e0 0a 00 00       	mov    %eax,0xae0
    base.s.size = 0;
 79d:	c7 05 e4 0a 00 00 00 	movl   $0x0,0xae4
 7a4:	00 00 00 
  }
 ...
 7fa:	a3 e8 0a 00 00       	mov    %eax,0xae8
      return (void*)(p + 1);
 ...
 805:	eb 3b                	jmp    842 <malloc+0xe1>
    ...
    if(p == freep)
 807:	a1 e8 0a 00 00       	mov    0xae8,%eax
